...
namespace LaptopBerles
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //4. feladat: Szürke Acer bérlések
            ...
            && k.LaptopRented.Color.Equals("szürke")).OrderByDescending(k => k.LaptopRented.InvNumber);
            ...
            //5. feladat: Vármegyék, ahol a legkevesebb laptopot bérelték
            ...
            Console.WriteLine("\tKeresett leltári szám: (kilépéshez nyomj: 0)");
            //Console.WriteLine("");
            while (true)
            {
                ...
                {
                    var laptopFind = rentalTransactionList.Where(k => k.LaptopRented.InvNumber == input).FirstOrDefault();
                    if (laptopFind == null)
                    {
            ...
            //7. feladat: A cég összes bevétele:
            ...
            foreach (RentalTransaction berles in rentalTransactionList)
            {
                ...
                int deposit = berles.UsedDeposit ? berles.LaptopRented.Deposit : 0;
                bevetel = bevetel + laptopFee * napok + deposit;
            }
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    {
                        laptopFind = rentalTransactionList.Where(k => k.LaptopRented.InvNumber == input).FirstOrDefault();
                        if (laptopFind == null)
                        {
                            Console.WriteLine("\tNincs ilyen leltári számú laptop a beolvasott adatok között");
                        ...
                        else
                        {
                            ...
                            Console.WriteLine($"8. feladat: Az LPT233271 leltári számú laptop bérlésenkénti " +
